...
<div class="mw8 center ph3 mt4">
  <div class="cf">
    <div class="fl w-100 tc mb5">
      <h1 class="f2 normal lh-copy">Monica is a team of 1. With dozens of external contributors.</h1>
      <div class="flex-ns ba b--gray-monica">
        <div class="w-20-ns w-100 b--gray-monica br">
          <h3 class="f3 mb0 mt3 normal">2016</h3>
          <p class="f6 mt2">First line of code</p>
        </div>
        <div class="w-20-ns w-100 b--gray-monica br">
          <h3 class="f3 mb0 mt3 normal">Montreal</h3>
        ...
        <div class="w-20-ns w-100 b--gray-monica br">
          <h3 class="f3 mb0 mt3 normal">84</h3>
          <p class="f6 mt2">Open source contributors</p>
        </div>
        <div class="w-20-ns w-100">
          <h3 class="f3 mb0 mt3 normal">85000</h3>
...
<div class="mw9 center ph3 mb5">
  <div class="cf">
    <div class="fl w-100">
      <p class="measure lh-copy center-ns">Our mission is to use technology in a way that does not harm human relationships, like big social networks can do.</p>
      <p class="measure lh-copy center-ns">In an age where people have thousands of virtual friends, we want to provide a tool that helps people strengthen the relationships with only a few of these friends. Make each friendship matter a lot.</p>
