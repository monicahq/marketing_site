...
<div class="mw8 center ph3">
  <div class="cf">
    <div class="fl w-100 tc mb3">
      <h1 class="f2 normal lh-copy mt0">Quickly see what's important and what's coming next</h1>
      <h2 class="normal lh-copy measure center">So you can focus on what really matters to you.</h2>
    </div>
  </div>
</div>
...
<div class="mw8 center ph3 mb5 mt4 relative">
  <div class="flex justify-center mb3">
    <img src="{{ secure_asset('img/dashboard.png') }}" width="601" height="390">
    <div class="absolute" style="top: 61px; left: 70px; width: 110px;">
      <div class="relative">
        <p class="lh-copy" style="color: #d33828;">See who you’ve last consulted</p>
    ...
    <div class="absolute" style="top: 232px; left: 80px; width: 120px;">
      <div class="relative">
        <p class="lh-copy" style="color: #d33828;">List of next planned events or reminders about your contacts</p>
    ...
    <div class="absolute" style="top: 110px; right: 70px; width: 130px;">
      <div class="relative">
        <p class="lh-copy" style="color: #d33828;">Consult your favorite notes about your contacts</p>
    ...
    <div class="absolute" style="top: 280px; right: 20px; width: 160px;">
      <div class="relative">
        <p class="lh-copy" style="color: #d33828;">Keep track of the calls you’ve made with people you care about</p>
...
<div class="mw8 center mb5 mt4 relative bt b--gray-monica">
  <div class="cf mb3">
