@extends('partials.skeleton', ['pageTitle' => 'Personal CRM - Monica privacy page'])
...
<div class="mw8 center ph3 mb6">
  <div class="cf">
    <div class="w-100 w-60-ns center">
      <p class="measure lh-copy">Monica is an open-source project. The hosted version has a premium plan that lets us collect money so we can pay for the servers and additional services, but the main goal is not to make money (otherwise we wouldn't have open-sourced it).</p>
      ...
      <p class="measure lh-copy">When you login to the service, we are using cookies to remember your login credentials. This is the only purpose of the cookies.</p>
      ...
      <p class="measure lh-copy">Your password is encrypted with bcrypt, a password hashing algorithm that is highly secure. You can also activate two factor authentication on your account if you need an extra layer of security. Apart from those encryption mechanisms, your data is not encrypted in the database. If someone gets access to the database, they will be able to read your data. We do our best to make sure that this never happens, but it can happen.</p>
      ...
      <p class="measure lh-copy">We use an open-source tool called Sentry to track errors that happen in production. Their service records the errors, but they don't have access to any information apart from the account ID, which lets me debug what's going on.</p>
      ...
      <p class="measure lh-copy">We do not use any tracking third parties, like Google Analytics or Intercom, that track user behaviours or data, neither on the marketing site or the hosted version. We are deeply against their principles as they would use those data to profile you, which we are totally against.</p>
      ...
      <p class="measure lh-copy">In certain situations, we may be required to disclose personal data in response to lawful requests by public authorities, including to meet national security or law enforcement requirements. We just hope that this never happens.</p>
