...
<html lang="en">
  ...
  <head>
    ...
    <meta property="og:image" content="{{ url('/img/social/posts/'.$post->created_at->format('Y-m-d').'/facebook.png') }}" />
    ...
    <meta property="og:image" content="{{ url('/img/social/posts/'.$post->created_at->format('Y-m-d').'/twitter.png') }}" />
